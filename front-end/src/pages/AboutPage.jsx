    ...
    <div className="mainCotainer">
      <main>
        ...
        <p>
          ...
          perfect car for their needs. Whether you're a first-time car buyer or
          a seasoned pro, we're here to make the process as smooth and
        ...
        <p>
          ...
          We believe that owning a car should be a source of pride and joy, and
          we are dedicated to making that a reality for each and every one of
          our customers.
        </p>
        <p>
